...
class AppDelegate: NSObject, UIApplicationDelegate {
    ...
    func applicationWillTerminate(_ application: UIApplication) {
        ...
        // Ne sauvegarder que si un compte est connecté et les services sont actifs
        guard Auth.auth().currentUser != nil, BluetoothManager.shared.isServiceActive else { return }
