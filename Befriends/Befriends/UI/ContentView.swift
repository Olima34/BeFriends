...
struct ContentView: View {
    ...
    // FIX #7 : Un seul HistoryViewModel partagé entre tous les onglets.
    // Évite deux listeners Firebase en double et des données divergentes.
    ...
    var body: some View {
        TabView(selection: $selectedTab) {
            ...
            HomeView(manager: manager, historyVM: historyVM, selectedTab: $selectedTab)
            ...
            // --- ONGLET 3 : AMIS ---
            FriendsView(manager: manager, historyVM: historyVM)
